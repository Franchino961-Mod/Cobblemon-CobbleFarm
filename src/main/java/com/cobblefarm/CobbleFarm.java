    ...
    public void onInitialize() {
        ...
        Registry.register(Registries.ITEM_GROUP, id("cobblefarm"), FabricItemGroup.builder()
                ...
                .entries((context, entries) -> {
                    ...
                    entries.add(CobbleFarmBlocks.COBBLEFARM_IRON.asItem());
                    entries.add(CobbleFarmBlocks.COBBLEFARM_GOLD.asItem());
                    entries.add(CobbleFarmBlocks.COBBLEFARM_DIAMOND.asItem());
                    entries.add(CobbleFarmBlocks.COBBLEFARM_EMERALD.asItem());
                    entries.add(CobbleFarmBlocks.COBBLEFARM_NETHERITE.asItem());
                })
                .build());
